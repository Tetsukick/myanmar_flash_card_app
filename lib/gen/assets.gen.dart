...
class $AssetsSvgGen {
  ...
  /// File path: assets/svg/event.svg
  SvgGenImage get event => const SvgGenImage('assets/svg/event.svg');

  /// File path: assets/svg/event_2.svg
  SvgGenImage get event2 => const SvgGenImage('assets/svg/event_2.svg');

  /// File path: assets/svg/event_3.svg
  SvgGenImage get event3 => const SvgGenImage('assets/svg/event_3.svg');

  /// File path: assets/svg/fashion.svg
  SvgGenImage get fashion => const SvgGenImage('assets/svg/fashion.svg');

  /// File path: assets/svg/fashion_2.svg
  SvgGenImage get fashion2 => const SvgGenImage('assets/svg/fashion_2.svg');

  /// File path: assets/svg/fashion_3.svg
  SvgGenImage get fashion3 => const SvgGenImage('assets/svg/fashion_3.svg');

  /// File path: assets/svg/fashion_4.svg
  SvgGenImage get fashion4 => const SvgGenImage('assets/svg/fashion_4.svg');
  ...
  /// File path: assets/svg/islam_2.svg
  SvgGenImage get islam2 => const SvgGenImage('assets/svg/islam_2.svg');
  ...
  /// File path: assets/svg/time_2.svg
  SvgGenImage get time2 => const SvgGenImage('assets/svg/time_2.svg');

  /// File path: assets/svg/tool.svg
  SvgGenImage get tool => const SvgGenImage('assets/svg/tool.svg');
  ...
  /// File path: assets/svg/unit_2.svg
  SvgGenImage get unit2 => const SvgGenImage('assets/svg/unit_2.svg');

  /// File path: assets/svg/vehicle.svg
  SvgGenImage get vehicle => const SvgGenImage('assets/svg/vehicle.svg');

  /// File path: assets/svg/vehicle_2.svg
  SvgGenImage get vehicle2 => const SvgGenImage('assets/svg/vehicle_2.svg');
  ...
  /// File path: assets/svg/work_2.svg
  SvgGenImage get work2 => const SvgGenImage('assets/svg/work_2.svg');
